            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`text-[11px] font-extrabold tracking-wider px-0.5 py-1.5 transition-all duration-200 border-b-2 ${
                    isActive 
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`text-left py-3 px-4 rounded font-bold text-xs tracking-wide transition-all ${
                    isActive 
